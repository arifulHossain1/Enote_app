<?php
   ...
   if(!mysqli_select_db($conn,'notes')){
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST'){
     if (isset($_POST['snoEdit'])){
       ...
       if($result){
        ...
        echo "The record was not updated succesfully because of this error --> ". mysqli_error($conn);
       }
     }
     else{
       $title= $_POST["title"];
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="/crud/Logo.png" alt="This is my logo" height="40px"></a>
